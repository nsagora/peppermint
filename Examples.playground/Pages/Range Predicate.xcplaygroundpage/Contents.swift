...
let inverval = RangePredicate(
    min: Date(timeIntervalSince1970: 0),
    max: Date(timeIntervalSince1970: 10000)
)

inverval.evaluate(with: Date(timeIntervalSince1970: 0))
inverval.evaluate(with: Date(timeIntervalSince1970: 1))
inverval.evaluate(with: Date(timeIntervalSince1970: 999))
inverval.evaluate(with: Date(timeIntervalSince1970: 10000))
inverval.evaluate(with: Date(timeIntervalSince1970: 10001))
