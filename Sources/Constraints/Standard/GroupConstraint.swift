...
extension Constraint {
    ...
    public static func group<C: Constraint>(_ mode: GroupConstraint<C.InputType, C.ErrorType>.Mode = .all, constraints: [C]) -> Self where Self == GroupConstraint<C.InputType, C.ErrorType> {
