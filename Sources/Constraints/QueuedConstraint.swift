 ...
 */
public protocol QueuedConstraint<InputType, ErrorType> {
     ...
     */
    func evaluate(with input: InputType, on queue: DispatchQueue, completionHandler: @escaping (_ result: Result<Void, Summary<ErrorType>>) -> Void)
}
